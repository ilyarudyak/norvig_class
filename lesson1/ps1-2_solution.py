...
# here is an explanation of this solution:
# 1) we replace card for list that contains this card and
#    joker for list of black or red cards; so we get smt like
#    [['6C'], ['7C'], ['8C'], ['9C'], ['TC'], ['5C'], ['2S', '2C', '3S' ....
# 2) now we use product and get substitution only for jokers;
#    again - the trick is to transform a card to [card]
# 3) we now simply find best 5-hand from each 7-hand and then iterate over them
